# OuiCal
[![travis](https://travis-ci.org/carlsednaoui/add-to-calendar-buttons.svg?branch=refactor)](https://travis-ci.org/carlsednaoui/add-to-calendar-buttons) [![Coverage Status](https://coveralls.io/repos/carlsednaoui/add-to-calendar-buttons/badge.png?branch=refactor)](https://coveralls.io/r/carlsednaoui/add-to-calendar-buttons)
